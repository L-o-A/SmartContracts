...
//         uint256 randomValue = IUtil(_admin.getUtilAddress()).randomNumber();
//         uint8 randomCount = 0;
...
//                 // uint32(_admin.random(nftAttribLimit._max[nftAttribLimit._default_attributes[i]] - nftAttribLimit._min[nftAttribLimit._default_attributes[i]], i * j));
//                 ((nftAttribLimit._max[nftAttribLimit._default_attributes[i]] - nftAttribLimit._min[nftAttribLimit._default_attributes[i]]) / 100 * IUtil(_admin.getUtilAddress()).sudoRandom(randomValue, randomCount ++));
//             }
...
//                     // uint32(_admin.random(nftAttribLimit._max[otherAttributes[i]] - nftAttribLimit._min[otherAttributes[i]], i * j));
//                     ((nftAttribLimit._max[otherAttributes[i]] - nftAttribLimit._min[otherAttributes[i]])  / 100 * IUtil(_admin.getUtilAddress()).sudoRandom(randomValue, randomCount ++));
//             }
