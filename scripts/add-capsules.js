...
async function main() {
   ...
   let capsules = await _capsuleData.getUserCapsules(user);
   ...
   await capsule.airdrop(1, user, 5);
   await capsule.airdrop(2, user, 5);
   await capsule.airdrop(3, user, 5);
   await capsule.airdrop(4, user, 5);
   await capsule.airdrop(5, user, 5);
   return;
